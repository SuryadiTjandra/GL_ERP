...
@Table(name="T0018")
@AttributeOverrides({
	@AttributeOverride(name="inputUserId", column=@Column(name="FPUID")),
	@AttributeOverride(name="inputDate", column=@Column(name="FPDTIN")),
	@AttributeOverride(name="inputTime", column=@Column(name="FPTMIN")),
