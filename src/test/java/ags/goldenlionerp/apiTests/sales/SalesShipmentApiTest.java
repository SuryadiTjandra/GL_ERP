...
public class SalesShipmentApiTest extends ApiTestBase<SalesShipmentPK> {
	...
	public void voidTest() throws Exception{
		...
		performer.performGet(location)
				...
				.andExpect(jsonPath("$.details[1].orderNumber").value(soDetails.get(0).get("salesOrderNumber")))
				.andExpect(jsonPath("$.details[1].orderType").value(soDetails.get(0).get("salesOrderType")))
				.andExpect(jsonPath("$.details[1].orderSequence").value(soDetails.get(0).get("salesOrderSequence")))
				...
				.andExpect(jsonPath("$.details[1].baseCurrency").value(soDetails.get(0).get("baseCurrency")))
				.andExpect(jsonPath("$.details[1].transactionCurrency").value(soDetails.get(0).get("transactionCurrency")))
				...
				//.andExpect(jsonPath("$.details[1].primaryTransactionQuantity").value(-1 * (double)soDetails.get(0).get("primaryTransactionQuantity")))
				.andExpect(jsonPath("$.details[1].primaryUnitOfMeasure").value(soDetails.get(0).get("primaryUnitOfMeasure")))
				...
				.andExpect(jsonPath("$.details[1].secondaryUnitOfMeasure").value(soDetails.get(0).get("secondaryUnitOfMeasure")))
				.andExpect(jsonPath("$.details[1].unitCost").value(soDetails.get(0).get("unitCost")))
				.andExpect(jsonPath("$.details[1].extendedCost").value(Matchers.closeTo(-1 * ((double)soDetails.get(0).get("unitCost")) * ((double) requestDetails.get(0).get("quantity")), 0.001)))
				.andExpect(jsonPath("$.details[1].taxBase").value(Matchers.closeTo(-1 * ((double)requestDetails.get(0).get("quantity")) / ((double)soDetails.get(0).get("quantity")) * ((double)soDetails.get(0).get("taxBase")), 0.001 )))
				.andExpect(jsonPath("$.details[1].taxAmount").value(Matchers.closeTo(-1 * ((double)requestDetails.get(0).get("quantity")) / ((double)soDetails.get(0).get("quantity")) * ((double)soDetails.get(0).get("taxAmount")), 0.001 )))
				.andExpect(jsonPath("$.details[1].lastStatus").value("980"))
				.andExpect(jsonPath("$.details[1].nextStatus").value("999"))
				.andExpect(jsonPath("$.details[1].paymentTermCode").value(soDetails.get(0).get("paymentTermCode")))
				.andExpect(jsonPath("$.details[1].taxCode").value(soDetails.get(0).get("taxCode")))
				.andExpect(jsonPath("$.details[1].taxAllowance").value(soDetails.get(0).get("taxAllowance")))
				.andExpect(jsonPath("$.details[1].taxRate").value(soDetails.get(0).get("taxRate")))
				.andExpect(jsonPath("$.details[1].discountCode").value(soDetails.get(0).get("discountCode")))
				.andExpect(jsonPath("$.details[1].discountRate").value(soDetails.get(0).get("discountRate")))
				.andExpect(jsonPath("$.details[1].unitDiscountCode").value(soDetails.get(0).get("unitDiscountCode")))
				.andExpect(jsonPath("$.details[1].unitDiscountRate").value(soDetails.get(0).get("unitDiscountRate")))
			//assert the voided receipt has its status changed
				.andExpect(jsonPath("$.details[0].lastStatus").value("980"))
		...
		performer.performGet(((Map<String, Map<String, Object>>) soDetails.get(0).get("_links")).get("order").get("href").toString())
				.andExpect(jsonPath("$.details[0].quantity").value(soDetails.get(0).get("quantity")))
				.andExpect(jsonPath("$.details[0].shippedQuantity").value(0.0))
