...
public class SalesOptions {
	...
	private SalesOptions() {}
	
	private SalesOptions(Builder builder) {
	...
	/**
	 * Creates builder to build {@link SalesOptions}.
	...
	/**
	 * Builder to build {@link SalesOptions}.
	 */
	public static final class Builder {
		...
		public SalesOptions build() {
			return new SalesOptions(this);
		}
	}
